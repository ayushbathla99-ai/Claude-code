...
## Task 1: Audit the Current Acquisition Funnel

**Objective:** Understand where customers are coming from and where they drop off.
...
- For each stage: Volume | Conversion rate | Drop-off cause (if known)
- A Funnel Leakage Analysis: Which stage has the biggest drop-off relative to potential?
- A Channel Attribution Summary: % of new customers from each source
...
- A Unit Economics Model:
  - LTV = ACV × Gross Margin × Average Customer Lifetime
  - CAC = Total acquisition spend ÷ New customers acquired
  - LTV:CAC Ratio (target: >3:1 for SaaS)
  - CAC Payback Period (target: <12 months for SaaS)
- A CAC Target by Channel: Maximum spend-per-customer that maintains healthy unit economics
- A "CAC Alert" framework: At what LTV:CAC ratio should you pause spending vs. scale?

---

## Task 3: Build the SEO & Content Acquisition Engine

**Objective:** Generate compounding organic traffic that reduces paid CAC over time.

**Ask the user:**
- What search terms would a buyer use when they first realize they have the problem you solve?
- Do you have any existing content? What is its current traffic?
...
## Task 4: Design the Paid Acquisition Playbook
...
- A Retargeting Playbook: How to re-engage visitors who didn't convert

---

## Task 5: Build the Outbound Acquisition System

**Objective:** Create a structured, scalable outbound pipeline generation machine.
...
## Task 6: Build the Partner & Referral Acquisition Channel
...
## Task 7: Optimize the Conversion Funnel

**Objective:** Increase the percentage of visitors and leads that become customers.

**Ask the user:**
- Where are you seeing the biggest drop-off in your funnel right now?
- What does your sign-up or demo request flow look like?
...
## Task 8: Build the Account-Based Marketing (ABM) Motion
...
## Task 9: Build the Acquisition Reporting Cadence

**Objective:** Create a rhythm of measurement that keeps acquisition efficient and improving.
